...
<script>
    ...
    $(function() {
        ...
        function makeDataTable(kelurahan_id = '', rw_id = '', rt_id = ''){
            const route = '{{ route('Beranda.Kontak.dataTables') }}'
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'nama_lokasi', name: 'nama_lokasi', className:'text-center'},
                    {data: 'email', name: 'email', className:'text-center'},
                    {data: 'web', name: 'web', className:'text-center'},
                    {data: 'rekening', name: 'rekening', className:'text-center'},
        ...
        $('.addNewData').click(function() {
            window.open("/Beranda/Kontak/create","_blank");
    ...
    const deleteData = async (id) => {
           const res = await fetch(`{{ route('Beranda.Kontak.destroy','') }}/${id}`,{
           ...
           if(status === 'success'){
             swal.fire("Success", "Kontak Berhasil Di Hapus!", "success");
    ...
    const deleteFunc = (id) => {
        swal.fire({
            title: "Konfirmasi",
            text: "Apakah anda yakin untuk menghapus kontak ini?",
            icon: "warning",
