				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<label>Gambar Header<span class="text-danger">*</span></label>
					...
					<div class="col-md-12">
						<div class="form-group mb-1">
							...
							<textarea name="keterangan" class="form-control" id="exampleTextarea" rows="3" placeholder="Masukkan keterangan"></textarea>
...
{!! JsValidator::formRequest('App\Http\Requests\Beranda\HeaderRequest','#headerForm') !!}
<script>
	const storeData = async () => {	
		...
		const res = async () => {
			return await fetch("{{route('Beranda.Header.store')}}",{
						headers:{
		...
		if(status === 'success'){
			...
			localStorage.setItem('success','Header Berhasil Ditambahkan');
