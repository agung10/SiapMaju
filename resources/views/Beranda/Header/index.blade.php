...
<script>
    ...
    $(function() {
        ...
        function makeDataTable(kelurahan_id = '', rw_id = '', rt_id = ''){
            const route = '{{ route('Beranda.Header.dataTables') }}'
        ...
        $('.addNewData').click(function() {
            window.open("/Beranda/Header/create","_blank");
    ...
    const deleteData = async (id) => {
           const res = await fetch(`{{ route('Beranda.Header.destroy','') }}/${id}`,{
           ...
           if(status === 'success'){
             swal.fire("Success", "Header Berhasil Di Hapus!", "success");
    ...
    const deleteFunc = (id) => {
        swal.fire({
            title: "Konfirmasi",
            text: "Apakah anda yakin untuk menghapus header ini?",
            icon: "warning",
