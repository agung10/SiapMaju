    ...
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap py-3">
            <div class="card-toolbar">
                @include('partials.buttons.add', ['text' => 'Tambah Data Covid'])
            </div>
        </div>
        <div class="card-body">
            <table class="table table-bordered table-checkable table-responsive" id="datatable">
                <thead>
                    <tr>
                        <th>No.</th>
                        <th width="300">Tanggal Input</th>
                        <th width="200">Jumlah Positif</th>
                        <th width="200">Jumlah Sembuh</th>
                        <th width="200">Jumlah Meninggal</th>
...
<script>
    ...
    $(function() {
        ...
        function makeDataTable(kelurahan_id = '', rw_id = '', rt_id = ''){
            const route = '{{ route('DataStatistik.DataCovid.dataTables') }}'
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'jml_positif', name: 'jml_positif', className:'text-center'},
                    {data: 'jml_sembuh', name: 'jml_sembuh', className:'text-center'},
                    {data: 'jml_meninggal', name: 'jml_meninggal', className:'text-center'},
    ...
    const deleteData = async (id) => {
           const res = await fetch(`{{ route('DataStatistik.DataCovid.destroy','') }}/${id}`,{
           ...
           if(status === 'success'){
             swal.fire("Success", "DataCovid Berhasil Di Hapus!", "success");
    ...
    const deleteFunc = (id) => {
        swal.fire({
            title: "Konfirmasi",
            text: "Apakah anda yakin untuk menghapus Data Covid19 ini?",
            icon: "warning",
