...
<script>
    ...
    $(function() {
        ...
        function makeDataTable(kelurahan_id = '', rw_id = '', rt_id = ''){
            const route = '{{ route('Tentang.ListPengurus.dataTables') }}'
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'kat_pengurus', name: 'kat_pengurus', className:'text-center'},
        ...
        $('.addNewData').click(function() {
            window.open("/Tentang/Pengurus/ListPengurus/create","_blank");
    ...
    const deleteData = async (id) => {
           const res = await fetch(`{{ route('Tentang.ListPengurus.destroy','') }}/${id}`,{
