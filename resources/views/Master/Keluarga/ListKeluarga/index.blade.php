                    ...
                    <div class="col-md-12">
                        <form class="form">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <select name="blok_id" class="form-control border-0 font-weight-bold" id="blok">
                                            <option></option>
                                        </select>
                                    </div>
                                </div>
    ...
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap py-3">
            <div class="card-toolbar">
                @include('partials.buttons.add', ['text' => 'Tambah Kepala Keluarga'])
                <a href="javascript:void(0)" class="btn btn-light-primary font-weight-bold addNewData d-none ml-5" target="_blank">
                    <i class="fas fa-plus-square"></i>
                    Tambah Data Kepala Keluarga Sesuai Pencarian
                </a>
            </div>
        </div>
        <div class="card-body">
...
<script>
    $(function() {
        ...
        function makeDataTable(province_id = '', city_id = '', subdistrict_id = '', kelurahan_id = '', rw_id = '', rt_id = '', blok_id = ''){
            const route = '{{ route('Master.ListKeluarga.dataTables') }}'
            ...
            var table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: route,
                    data:{province_id:province_id, city_id:city_id, subdistrict_id:subdistrict_id, kelurahan_id:kelurahan_id, rw_id:rw_id, rt_id:rt_id, blok_id:blok_id}
                },
                columns: [
                    ...
                    {data: 'anggota_keluarga_count', searchable: false , className:'text-center'},
        ...
        $('#filter').click(function(){
            ...
            var rw_id = $('#rw').val();
            var rt_id = $('#rt').val();
            var blok_id = $('#blok').val();

            if (province_id == '') {
                swal.fire("Informasi", "Anda belum memilih alamat pencarian!", "info");
            } else {
                $('#datatable').DataTable().destroy();
                makeDataTable(province_id, city_id, subdistrict_id, kelurahan_id, rw_id, rt_id, blok_id);
            }
        });
        ...
        $('.addNewData').click(function() {
            window.open("/Master/Keluarga/ListKeluarga/create","_blank");
            var value = JSON.stringify({
                ...
                blok_id: $('select[name=blok_id]').val()
            })
    ...
    const deleteData = async (id) => {
           const res = await fetch(`{{ route('Master.ListKeluarga.destroy','') }}/${id}`,{
