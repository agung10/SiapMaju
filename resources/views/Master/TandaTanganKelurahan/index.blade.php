    ...
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap py-3">
            <div class="card-toolbar">
                @include('partials.buttons.add', ['text' => 'Tambah Tanda Tangan Kelurahan'])
                <a href="javascript:void(0)" class="btn btn-light-primary font-weight-bold addNewData d-none ml-5">
                    <i class="fas fa-plus-square"></i>
                    Tambah Tanda Tangan Kelurahan Sesuai Pencarian
                </a>
            </div>
        </div>
        <div class="card-body">
...
<script>
    $(function() {
        ...
        function makeDataTable(province_id = '', city_id = '', subdistrict_id = ''){
            const route = '{{ route('Master.TandaTanganKelurahan.dataTables') }}'
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'tanda_tangan_kelurahan', name: 'tanda_tangan_kelurahan', className:'text-center'},
        ...
        $('.addNewData').click(function() {
            window.open("/Master/TandaTanganKelurahan/create","_blank");
    ...
    const deleteData = async (id) => {
        const res = await fetch(`{{ route('Master.TandaTanganKelurahan.destroy', '') }}/${id}`,{
    ...
    const deleteFunc = (id) => {
        swal.fire({
            title: "Konfirmasi",
            text: "Apakah anda yakin untuk menghapus TandaTanganKelurahan?",
            icon: "warning",
