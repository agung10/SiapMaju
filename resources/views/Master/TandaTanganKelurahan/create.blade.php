...
<div class="container">
	...
	<div class="card card-custom gutter-b">
		<form id="headerForm" action="{{ route('Master.TandaTanganKelurahan.store') }}" enctype="multipart/form-data"
			method="POST">
			@csrf
			<div class="card-body">
...
<script>
	const storeData = async () => {
		...
		const res = async () => {
			return await fetch("{{route('Master.TandaTanganKelurahan.store')}}",{
				headers:{
		...
		if(status === 'success'){
			localStorage.setItem('success','Berhasil Menambahkan Tanda Tangan Kelurahan');
    ...
    const iField = document.querySelector('input[name="tanda_tangan_kelurahan"]')
