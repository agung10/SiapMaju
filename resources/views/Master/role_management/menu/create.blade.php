...
<div class="container">
	...
	<div class="card card-custom gutter-b">
		<form id="headerForm" action="{{route('master.menu.store')}}" method="POST">
			@csrf
			<div class="card-body">
				<div class="row">
					<div class="col-md-6">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label>Route </label>
							<input type="text" name="route" class="form-control"  placeholder="Masukan Nama Route"/>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label>Icon</label>
							<input type="text" name="icon" class="form-control"  placeholder="Masukan Nama Role"/>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="order" class="form-control"  placeholder="Masukan urutan Menu"/>
	...
	<script>
		...
		const storeData = async () => {
			...
			const res = await fetch("{{route('master.menu.store')}}",{
				headers:{
			...
			if(status === 'success'){
				...
				localStorage.setItem('success','Menu Berhasil Ditambahkan');
