...
<script>
    ...
    $(document).ready(function(){
        var table = $('#datatable').DataTable({
            ...
            serverSide: true,
            responsive:true,
            ajax: "{{ route('master.permission.dataTables') }}",
            columns: [
            {data: 'DT_RowIndex', name: 'DT_RowIndex', className:'text-center'},
            {data: 'permission_name', name: 'permission_name', className:'text-center'},
            {data: 'description', name: 'description', className:'text-center'},
            {data: 'permission_action', name: 'permission_action', className:'text-center'},
    ...
    const deleteData = async (id) => {
        const res = await fetch(`{{ route('master.permission.destroy','') }}/${id}`,
        {
    ...
    const deleteFunc = (id) => {
        swal.fire({
            title: "Konfirmasi",
            text: "Apakah anda yakin untuk menghapus permission ?",
            icon: "warning",
