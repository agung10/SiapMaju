...
<div class="container">
    ...
    <div class="card card-custom gutter-b">
			<form id="headerForm" action="{{route('master.role.store')}}" method="POST">
				@csrf
				<div class="card-body">
					<div class="form-group">
						<label>Nama <span class="text-danger">*</span></label>
						<input type="text" name="role_name" class="form-control"  placeholder="Masukan Nama Role"/>
...
<script>
	...
	const storeData = async () => {
		...
		const res = await fetch("{{route('master.role.store')}}",{
						headers:{
		...
		if(status === 'success'){
			...
			localStorage.setItem('success','Role Berhasil Ditambahkan');
