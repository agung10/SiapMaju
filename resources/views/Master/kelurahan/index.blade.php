...
<script>
    $(function() {
        ...
        function makeDataTable(province_id = '', city_id = '', subdistrict_id = ''){
            const route = '{{ route('Master.kelurahan.dataTables') }}'
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'kode_pos', name: 'kode_pos', className:'text-center'},
        ...
        $('.addNewData').click(function() {
            window.open("/Master/Kelurahan/create","_blank");
    ...
    const deleteData = async (id) => {
        const res = await fetch(`{{ route('Master.kelurahan.destroy', '') }}/${id}`,{
    ...
    const deleteFunc = (id) => {
        swal.fire({
            title: "Konfirmasi",
            text: "Apakah anda yakin untuk menghapus Kelurahan?",
            icon: "warning",
