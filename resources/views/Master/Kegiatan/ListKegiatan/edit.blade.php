...
<div class="container">
	...
	<div class="card card-custom gutter-b">
		<form id="headerForm" action="{{ route('Master.ListKegiatan.update', $data->kegiatan_id) }}" method="POST">
			@csrf
			{{ method_field('PATCH') }}
			<div class="card-body">
				<h4>Data Kegiatan</h4>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<div style="font-size:10px;margin:5px;color:red" class="err-kat_kegiatan_id"></div>
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label>Nama Kategori<span class="text-danger">*</span></label>
							<input type="text" value="{{ $data->nama_kegiatan }}" name="nama_kegiatan"
								class="form-control" />
							<div style="font-size:10px;margin:5px;color:red" class="err-nama_kegiatan"></div>
						</div>
					</div>
				</div>
...
<script>
	...
	const storeData = async () => {
		...
		const res = await fetch(`{{route('Master.ListKegiatan.update', '')}}/{{\Request::segment(4)}}`,{
		...
		if(status === 'success'){
			...
			localStorage.setItem('success','Kegiatan Berhasil Diupdate');
