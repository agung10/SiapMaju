...
<div class="container">
	...
	<div class="card card-custom gutter-b">
		<form id="dataForm" action="{{ route('Master.rw.store') }}" enctype="multipart/form-data" method="POST">
			@csrf
			<div class="card-body">
				<div class="row">
					<div class="col-md-4">
...
<script>
	...
	const res = async () => {
		return await fetch("{{route('Master.rw.store')}}", {
			headers: {
		...
		if(status === 'success'){
			localStorage.setItem('success','Berhasil Menambahkan RW');
