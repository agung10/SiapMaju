...
<script>
    $(function() {
        ...
        function makeDataTable(province_id = '', city_id = '', subdistrict_id = '', kelurahan_id = ''){
            const route = '{{ route('Master.rw.dataTables') }}'
            ...
            var table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: route,
                    data:{province_id:province_id, city_id:city_id, subdistrict_id:subdistrict_id, kelurahan_id:kelurahan_id}
                },
                columns: [
        ...
        $('#filter').click(function(){
            ...
            if (province_id == '') {
                ...
                makeDataTable(province_id, city_id, subdistrict_id, kelurahan_id);
            }
        });
        ...
        $('.addNewData').click(function() {
            window.open("/Master/RW/create","_blank");
    ...
    const deleteData = async (id) => {
        const res = await fetch(`{{ route('Master.rw.destroy','') }}/${id}`,{
    ...
    const deleteFunc = (id) => {
        swal.fire({
            title: "Konfirmasi",
            text: "Apakah anda yakin untuk menghapus RW?",
            icon: "warning",
