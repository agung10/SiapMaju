...
<div class="container">
	...
	<div class="card card-custom gutter-b">
		<form id="dataForm" action="{{ route('Master.Tanda_Tangan_RT.store') }}" enctype="multipart/form-data" method="POST">
			@csrf
			<div class="card-body">
...
<script>
	const storeData = async () => {
		...
		const res = async () => {
			return await fetch("{{route('Master.Tanda_Tangan_RT.store')}}",{
				headers:{
		...
		if(status === 'success'){
			localStorage.setItem('success','Berhasil Menambahkan Tanda Tangan RT');
    ...
    const iField = document.querySelector('input[name="tanda_tangan_rt"]')
