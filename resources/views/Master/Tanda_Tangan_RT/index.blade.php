...
<script>
    $(function() {
        ...
        function makeDataTable(kelurahan_id = '', rw_id = ''){
            const route = '{{ route('Master.Tanda_Tangan_RT.dataTables') }}'
        ...
        $('.addNewData').click(function() {
            window.open("/Master/TandaTanganRT/create","_blank");
    ...
    const deleteData = async (id) => {
        const res = await fetch(`{{ route('Master.Tanda_Tangan_RT.destroy', '') }}/${id}`,{
    ...
    const deleteFunc = (id) => {
        swal.fire({
            title: "Konfirmasi",
            text: "Apakah anda yakin untuk menghapus TandaTanganRT?",
            icon: "warning",
