...
<script>
    $(function() {
        ...
        function makeDataTable(kelurahan_id = ''){
            const route = '{{ route('Master.TandaTanganRW.dataTables') }}'
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'tanda_tangan_rw', name: 'tanda_tangan_rw', className:'text-center'},
        ...
        $('.addNewData').click(function() {
            window.open("/Master/TandaTanganRW/create","_blank");
    ...
    const deleteData = async (id) => {
        const res = await fetch(`{{ route('Master.TandaTanganRW.destroy', '') }}/${id}`,{
    ...
    const deleteFunc = (id) => {
        swal.fire({
            title: "Konfirmasi",
            text: "Apakah anda yakin untuk menghapus TandaTanganRW?",
            icon: "warning",
