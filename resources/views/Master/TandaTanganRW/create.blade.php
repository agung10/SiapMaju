...
<div class="container">
	...
	<div class="card card-custom gutter-b">
		<form id="dataForm" action="{{ route('Master.TandaTanganRW.store') }}" enctype="multipart/form-data" method="POST">
			@csrf
			<div class="card-body">
...
<script>
	const storeData = async () => {
		...
		const res = async () => {
			return await fetch("{{route('Master.TandaTanganRW.store')}}",{
				headers:{
		...
		if(status === 'success'){
			localStorage.setItem('success','Berhasil Menambahkan Tanda Tangan RW');
    ...
    const iField = document.querySelector('input[name="tanda_tangan_rw"]')
