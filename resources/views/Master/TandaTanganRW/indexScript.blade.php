<script>
    ...
    $(document).ready(function(){
        var table = $('#datatable').DataTable({
            ...
            serverSide: true,
            responsive:true,
            ajax: "{{ route('Master.TandaTanganRW.dataTables') }}",
            columns: [
    ...
    function editCapHandler(e){
        ...
        async function capFormHandler(){
            ...
            const updateCap = async () => {
                ...
                return await fetch(`{{route('Master.TandaTanganRW.update','')}}/${cap_id}`,{
                                    headers:{
                ...
                KTApp.unblockPage()
                swal.fire('Tandan Tangan RW Berhasil di Update','','success')
