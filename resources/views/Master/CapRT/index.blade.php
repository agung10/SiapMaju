...
<script>
    $(function() {
        ...
        function makeDataTable(kelurahan_id = '', rw_id = ''){
            const route = '{{ route('Master.CapRT.dataTables') }}'
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'cap_rt', name: 'cap_rt', className:'text-center'},
        ...
        $('.addNewData').click(function() {
            window.open("/Master/CapRT/create","_blank");
    ...
    const deleteData = async (id) => {
        const res = await fetch(`{{ route('Master.CapRT.destroy', '') }}/${id}`,{
    ...
    const deleteFunc = (id) => {
        swal.fire({
            title: "Konfirmasi",
            text: "Apakah anda yakin untuk menghapus CapRT?",
            icon: "warning",
