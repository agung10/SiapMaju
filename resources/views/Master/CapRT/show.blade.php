		...
		<div class="card-body">
			<div class="form-group">
				<div class="imageContainer mx-auto d-block">
					<img class="imagePicture mx-auto d-block" src="{{ ((!empty($data)) ? ((!empty($data->cap_rt)) ? (asset('uploaded_files/cap_rt/'.$data->cap_rt)) : (asset('images/NoPic.png'))) : (asset('images/NoPic.png'))) }}" width="100" height="100"></img>
				</div>
				<label class="l-center">Cap RT</label>
			</div>
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
