...
<script>
    $(function() {
        ...
        function makeDataTable(province_id = '', city_id = '', subdistrict_id = '', kelurahan_id = '', rw_id = '', rt_id = ''){
            const route = '{{ route('Master.Blok.dataTables') }}'
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'longitude', name: 'blok.long', className:'text-center'},
                    {data: 'latitude', name: 'blok.lang', className:'text-center'},
                    {data: 'action', name: 'action', className:'text-center', searchable: false , orderable: false},
                    {data: 'updated_at', name: 'blok.updated_at', searchable: false, visible: false},
                ],
                "order": [[ 1, "asc" ], [ 5, "desc" ]],
        ...
        $('.addNewData').click(function() {
            window.open("/Master/Blok/create","_blank");
    ...
    const deleteData = async (id) => {
           const res = await fetch(`{{ route('Master.Blok.destroy','') }}/${id}`,{
    ...
    const deleteFunc = (id) => {
        swal.fire({
            title: "Konfirmasi",
            text: "Apakah anda yakin untuk menghapus blok?",
            icon: "warning",
