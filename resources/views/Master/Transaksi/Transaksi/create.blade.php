...
<div class="container">
    ...
    <div class="card card-custom gutter-b">
		<form id="headerForm" action="{{ route('Master.Transaksi.store') }}" enctype="multipart/form-data" method="POST">
			@csrf
			<div class="card-body">
...
<script>
	...
	const storeData = async () => {
		...
		const res = async () => {
			return await fetch("{{route('Master.Transaksi.store')}}",{
						headers:{
		...
		if(status === 'success'){
			...
			localStorage.setItem('success','Berhasil Ditambahkan di Transaksi');
