...
@section('content')
    ...
    <div class="container">
        ...
        <div class="card card-custom gutter-b">
            <form id="headerForm" action="{{ route('RamahAnak.Posyandu.store') }}" method="POST">
                {{ csrf_field() }}
                <div class="card-body row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="ket_vaksinasi" class="form-control" rows="5" placeholder="Masukkan Keterangan Vaksinasi (opsional)"></textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Berat Badan (kg)<span class="text-danger">*</span></label>
                            <input type="text" name="berat" class="form-control" placeholder="Masukkan Berat Badan" />
                        </div>
                        <div class="form-group">
                            <label>Tinggi Badan (cm)<span class="text-danger">*</span></label>
                            <input type="text" name="tinggi" class="form-control" placeholder="Masukkan Tinggi Badan" />
                        </div>
                        <div class="form-group">
                            <label>Lingkar Kepala (cm)<span class="text-danger">*</span></label>
                            <input type="text" name="lingkar_kepala" class="form-control" placeholder="Masukkan Lingkar Kepala" />
                        </div>
                        <div class="form-group">
                            <label>Nilai Stunting<span class="text-danger">*</span></label>
                            <input type="text" name="nilai_stunting" class="form-control" placeholder="Masukkan Nilai Stunting" />
                        </div>
                        <div class="form-group">
                            <label>Keluhan</label>
                            <textarea name="keluhan" class="form-control" rows="5" placeholder="Masukkan Keluhan (opsional)"></textarea>
                        </div>
                    </div>
                </div>
