...
@section('content')
    ...
    <div class="container">
        ...
        <div class="card card-custom gutter-b">
            <form id="headerForm" action="{{ route('RamahAnak.Vaksin.store') }}" method="POST">
                {{ csrf_field() }}
                <div class="card-body row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Nama Vaksin<span class="text-danger">*</span></label>
                            <input type="text" name="nama_vaksin" class="form-control" placeholder="Masukkan Nama Vaksin" />
                        </div>
                        <div class="form-group">
                            <label>Keterangan</label>
                            <textarea name="keterangan" class="form-control" rows="5" placeholder="Masukkan Keterangan (opsional)"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Wajib?</label>
                            <label class="switch">
                                <input type="checkbox" name="wajib" checked class="form-control" data-label="Wajib">
                        ...
                        <div class="form-group">
                            <label>Status?</label>
                            <label class="switch">
                                <input type="checkbox" name="status_aktif" checked class="form-control" data-label="Aktif">
                                <span class="slider round"></span>
                                <code>Aktif</code>
                            </label>
                        </div>
