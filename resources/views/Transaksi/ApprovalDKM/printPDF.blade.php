...
<div class="container">
    <table class="tableHeader">
        <tr>
            <th style="text-align:left;border-bottom:1px solid;">Transaksi: <span style="font-weight:normal;">{{$data->nama_transaksi}}</span></th>
            <th style="text-align:right;border-bottom:1px solid;">Kegiatan  <span style="font-weight:normal;">{{$data->nama_kegiatan}}</span></th>
        </tr>
        <tr>
            <th style="text-align:left;line-height:20px;">No. Bukti<br> <span style="font-weight:normal;">{{$data->no_bukti}}</span></th>
            <th style="text-align:right;line-height:20px;">Tanggal: <span style="font-weight:normal;">{{$tanggal}}</span></th>
        </tr>
        <tr>
            ...
            <th style="text-align:right;line-height:20px;">Nama (Kepala Keluarga)<br> <span style="font-weight:normal;">{{$data->nama}}</span></th>
        </tr>
        <tr >
            <th style="text-align:left;line-height:20px;">No. Pendaftaran<br> <span style="font-weight:normal;">{{$data->no_pendaftaran}}</span></th>
            <th style="text-align:right;line-height:20px;">Alamat<br> <span style="font-weight:normal;">{{$data->alamat}}</span></th>
        </tr>
    </table>
