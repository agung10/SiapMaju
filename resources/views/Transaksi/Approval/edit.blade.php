...
<div class="container">
	...
	<form class="form" method="post" action="{{route('Transaksi.Approval.update',$data->header_trx_kegiatan_id)}}">
		@method('PUT')
		@csrf
		<div class="card-body">
			<div class="form-group row">
				<div class="col-lg-6">
					<label>Transaksi</label>
						<input disabled type="text" value="{{!empty($data->nama_kegiatan) ? $data->nama_kegiatan : ''}}" class="form-control" placeholder="Transaksi"/>
			...
			<div class="form-group row">
				<div class="col-lg-12">
					...
					<div class="form-group row">
						...
						<div class="col-lg-3">
							<input type="month" disabled value="{{date('Y-m',strtotime($data->created_at))}}" class="form-control headerInput monthPendaftaran" placeholder="Pilih Bulan"/>
							<span class="errorHeader"></span>
						</div>
					</div>
				</div>
