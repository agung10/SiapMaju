...
@section('content')
        ...
        <div class="card card-custom gutter-b">
            <div class="card-body">
                <div class="form-surat-container">
                    <form id="kepala-lurah" action="{{ route('Kelurahan.Lurah.update', \Crypt::encryptString($data->surat_permohonan_id)) }}" method="POST">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                        <div class="row">
                        ...
                        <div class="card-footer" style="padding:2rem 0;">
                            <button type="submit" class="btn btn-warning btn-submit">Approval Lurah</button>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('body').on('submit', 'form#kepala-lurah', function(e) {
                e.preventDefault();
