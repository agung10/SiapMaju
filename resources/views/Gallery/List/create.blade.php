...
<div class="container">
	...
	<div class="card card-custom gutter-b">
		<form id="headerForm" action="{{ route('Gallery.List.store') }}" enctype="multipart/form-data" method="POST">
			@csrf
			<div class="card-body">
				...
				<div class="form-group">
					...
					<div class="upload-container">
						<input type="file" id="file-input" name="image_cover[]" multiple accept="image/*"/>
					</div>
...
<script>
	const storeData = async () => {
		let is_valid = false
		const collection = Array.from(document.getElementsByClassName('detail-galeri'))
		...
		const res = async () => {
			return await fetch("{{route('Gallery.List.store')}}",{
						headers:{
...
@include('Gallery.List.script')
@endsection

@push('custom-css')
@include('Gallery.List.css')
@endpush