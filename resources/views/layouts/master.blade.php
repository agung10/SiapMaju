...
<html lang="en" >
	<head>
		<base href="">
			<meta charset="utf-8"/>
			<title>Platform Digital SiapMaju</title>
			...
			<link rel="stylesheet" href="{{asset('js/datepicker/datepicker.min.css')}}">
			<link rel="stylesheet" href="https://unpkg.com/leaflet@1.7.1/dist/leaflet.css"
   integrity="sha512-xodZBNTC5n17Xt2atTPuE1HxjVMSvLVW9ocqUKLsCC5CXdbqCmblAshOMAS6/keqq/sMZMZ19scR4PsZChSR7A=="
   crossorigin=""/>
			<script language="JavaScript" type="text/javascript" src="{{asset('assets/js/jquery-3.6.0.js')}}"></script>
   ...
   crossorigin=""></script>
  			<script type="text/javascript" src="{{asset('assets/js/qrcode/instascan.min.js')}}"></script>
		...
		<body  id="kt_body"  class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed subheader-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading"  >
			<div id="kt_header_mobile" class="header-mobile align-items-center  header-mobile-fixed " >
				...
				<a href="{{route('landing.index')}}">
					<p class="logo-masjid">Platform Digital SiapMaju</p>
				</a>
				<!--end::Logo-->
				<!--begin::Toolbar-->
					...
					<div class="aside aside-left  aside-fixed  d-flex flex-column flex-row-auto"  id="kt_aside">
						...
						<div class="brand flex-column-auto " id="kt_brand">
							...
							<a href="{{route('landing.index')}}" class="brand-logo">
								<p style="font-size:12px;font-weight:bold;" class="logo-masjid">Platform Digital SiapMaju</p>
							</a>
							<!--end::Logo-->
							<!--begin::Toggle-->
									...
									<div class="topbar-item">
										<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
											...
											<span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
												<span class="symbol-label font-size-h5 font-weight-bold initial">S</span>
											</span>
										</div>
									</div>
									<!--end::User-->
			...
			<Script>
				...
				$('.initial').html(user.charAt(0).toUpperCase());
			</Script>
