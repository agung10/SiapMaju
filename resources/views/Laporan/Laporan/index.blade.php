...
<script>
    ...
    $(function() {
        ...
        function makeDataTable(kelurahan_id = '', rw_id = '', rt_id = ''){
            const route = '{{ route('Laporan.Laporan.dataTables') }}'
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'nama_kat', name: 'nama_kat', className:'text-center'},
                    {data: 'laporan', name: 'laporan', className:'text-center'},
        ...
        $('.addNewData').click(function() {
            window.open("/Laporan/Laporan/create","_blank");
    ...
    const deleteData = async (id) => {
           const res = await fetch(`{{ route('Laporan.Laporan.destroy','') }}/${id}`,{
