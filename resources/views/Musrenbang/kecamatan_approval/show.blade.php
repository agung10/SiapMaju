...
<div class="container">
	...
	<div class="card card-custom gutter-b">
		<form id="Approval-Kecamatan" action="{{ route('Musrenbang.Approval-Kecamatan.update', \Crypt::encryptString($data->usulan_urusan_id)) }}" method="POST">
			{{ csrf_field() }}
			{{ method_field('PATCH') }}
			...
			<div class="card-footer">
				@if ($data->status_usulan == 2)
					<button type="submit" class="btn btn-warning btn-submit">Approval Kecamatan</button>
				@endif
