...
<div class="container">
	...
	<div class="card card-custom gutter-b">
		<form id="headerForm" action="{{route('Pengumuman.List.store')}}" enctype="multipart/form-data" method="POST">
			@csrf
			<div class="card-body">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<textarea name="pengumuman" class="form-control" rows="3"></textarea>
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<div class="imageContainerPengumuman">
								<img class="imagePicturePengumuman" src="{{asset('images/NoPic.png')}}" />
							</div>
...
<script>
	const storeData = async () => {
		...
		const res = async () => {
			return await fetch("{{route('Pengumuman.List.store')}}",{
						headers:{
		...
		if(status === 'success'){
			...
			localStorage.setItem('success','Pengumuman Berhasil Ditambahkan');
