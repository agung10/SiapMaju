...
<script>
    ...
    $(function() {
        ...
        function makeDataTable(kelurahan_id = '', rw_id = '', rt_id = ''){
            const route = '{{ route('Pengumuman.List.dataTables') }}'
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'pengumuman', name: 'pengumuman', width:'1000px', className:'text-center'},
                    {data: 'image1', name: 'image1', className:'text-center'},
                    {data: 'image2', name: 'image2', className:'text-center'},
                    {data: 'image3', name: 'image3', className:'text-center'},
                    {
                        name: 'tanggal.raw',
                        data: {
                            _: 'tanggal.display',
        ...
        $('.addNewData').click(function() {
            window.open("/Pengumuman/List/create","_blank");
    ...
    const deleteData = async (id) => {
           const res = await fetch(`{{ route('Pengumuman.List.destroy','') }}/${id}`,{
           ...
           if(status === 'success'){
             swal.fire("Success", "Pengumuman Berhasil Di Hapus!", "success");
