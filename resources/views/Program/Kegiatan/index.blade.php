    ...
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap py-3">
            <div class="card-toolbar">
                @include('partials.buttons.add', ['text' => 'Tambah Program Kegiatan'])
                <a href="javascript:void(0)" class="btn btn-light-primary font-weight-bold addNewData d-none ml-5">
                    <i class="fas fa-plus-square"></i>
                    Tambah Data Program Kegiatan Sesuai Pencarian
                </a>
            </div>
        </div>
        <div class="card-body">
...
<script>
    ...
    $(function() {
        ...
        function makeDataTable(kelurahan_id = '', rw_id = '', rt_id = ''){
            const route = '{{ route('Program.Kegiatan.dataTables') }}'
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'nama_program', name: 'nama_program', className:'text-center'},
                    {data: 'program', name: 'program', className:'text-center'},
        ...
        $('.addNewData').click(function() {
            window.open("/Program/Kegiatan/create","_blank");
    ...
    const deleteData = async (id) => {
           const res = await fetch(`{{ route('Program.Kegiatan.destroy','') }}/${id}`,{
           ...
           if(status === 'success'){
             swal.fire("Success", "Kegiatan Berhasil Di Hapus!", "success");
    ...
    const deleteFunc = (id) => {
        swal.fire({
            title: "Konfirmasi",
            text: "Apakah anda yakin untuk menghapus program kegiatan ini?",
            icon: "warning",
