...
@section('content')
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-12 mt-8">
                        <div class="chart" style="padding:10px; background:#EFEFEF; border-radius:10px; height:400px;">
                            <div id="pollingChart2" class="d-flex justify-content-center"></div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            const apexChart = "#pollingChart2";
            var options = {
                series: [{
                    name: 'Jumlah Suara',
                    data: @json($pollDataRT['percentage'])
                }],
                chart: {
                    type: 'bar',
                    height: 350,
                ...
                xaxis: {
                    categories: @json($pollDataRT['label']),
                    labels: {
                        show: true,
                        rotate: -45,
                        trim: true,
                ...
                yaxis: {
                    title: {
                        text: "JUMLAH SUARA BERDASARKAN RT (%)",
                        style: {
                            color: primary,
                        }
                    }
            ...
            var newChart = new ApexCharts(document.querySelector(apexChart), options);
            newChart.render();
        });
    </script>
@endsection