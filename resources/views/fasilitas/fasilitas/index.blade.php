...
<script>
    ...
    $(function() {
        ...
        function makeDataTable(kelurahan_id = '', rw_id = '', rt_id = ''){
            const route = '{{ route('fasilitas.fasilitas.dataTables') }}'
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data: "nama_fasilitas", name: "nama_fasilitas" , className: "text-center" },
        ...
        $('.addNewData').click(function() {
            window.open("/fasilitas/fasilitas/create","_blank");
    ...
    const deleteData = async (id) => {
        const res = await fetch(`{{ route('fasilitas.fasilitas.destroy','') }}/${id}`, {
        ...
        if (status === "success") {
            swal.fire("Success", "Fasilitas Berhasil Di Hapus!", "success");
    ...
    const deleteFunc = (id) => {
        swal.fire({
            title: "Konfirmasi",
            text: "Apakah anda yakin untuk menghapus fasilitas ini?",
            icon: "warning",
