...
class KajianController extends Controller
{
    ...
    public function __construct(KajianRepository $_KajianRepository, RajaOngkirRepository $rajaOngkir, UserRepository $_user)
    {
    ...
    {   
        $kat_kajian = helper::select('kat_kajian','kategori'); 
        ...
        return view($this->route1 . '.' . $this->route2 . '.' . $this->route3, compact('kat_kajian', 'resultRT', 'resultRW', 'resultKelurahan', 'isAdmin', 'isRw', 'isRt'));
    }

    public function store(Request $request)
    {   
        return $this->kajian->store($request);
    }

    public function show($id)
    {   
        $id = \Crypt::decryptString($id);
        $data = $this->kajian->show($id);
        $kat_kajian = helper::select('kat_kajian','kategori',$data->kat_kajian_id); 
        $kajianGetAlamat = $this->kajian->getAlamat($id);
        
        return view($this->route1.'.'.$this->route2.'.'.$this->route3,compact('data','kat_kajian', 'kajianGetAlamat'));
    }
    ...
    {   
        ...
        return view($this->route1.'.'.$this->route2.'.'.$this->route3,compact('data','kat_kajian', 'resultRT', 'resultRW', 'resultKelurahan'));
    }
    ...
    {   
        ...
        return $this->kajian->update($request,$id);
    }

    public function destroy($id)
    {
        return $this->kajian->delete($id);
    }

    public function deleteMateri(Request $request,$id)
    {
        return $this->kajian->deleteMateri($request,$id);
    }

    public function checkMateri($id)
    {
        return $this->kajian->checkMateri($id);
    }

    public function dataTables(Request $request)
    {
        return $this->kajian->dataTables($request);
    }
}
