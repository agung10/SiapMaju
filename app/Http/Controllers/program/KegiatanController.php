...
{
    public function __construct(ProgramRepository $_ProgramRepository, RajaOngkirRepository $rajaOngkir, UserRepository $_user)
    {
        ...
        $this->program = $_ProgramRepository;
    ...
    {   
        ...
        $data = $this->program->show($id);
        $programGetAlamat = $this->program->getAlamat($id);

        return view($this->route1.'.'.$this->route2.'.'.$this->route3,compact('data', 'programGetAlamat'));
    }
    ...
    {   
        ...
        return $this->program->update($request,$id);
    }
    ...
    {
        return $this->program->dataTables($request);
    }
}
