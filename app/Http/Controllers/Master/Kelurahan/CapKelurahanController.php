...
use App\Repositories\Master\CapKelurahanRepository;
use App\Repositories\Master\KelurahanRepository;
use App\Repositories\RajaOngkir\RajaOngkirRepository;
use Illuminate\Http\Request;

class CapKelurahanController extends Controller
{
    public function __construct(CapKelurahanRepository $_CapKelurahanRepository, RajaOngkirRepository $rajaOngkir, KelurahanRepository $kelurahan)
    {
        ...
        $this->capKelurahan = $_CapKelurahanRepository;
    ...
    {
        return $this->capKelurahan->store($request);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return $this->capKelurahan->update($request, $id);
    }
    ...
    {
        return $this->capKelurahan->delete($id);
    }

    public function dataTables(Request $request)
    {
        return $this->capKelurahan->dataTables($request);
    }
}
