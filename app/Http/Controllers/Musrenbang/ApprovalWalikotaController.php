...
class ApprovalWalikotaController extends Controller
{
    ...
    {
        return view('Musrenbang.walikota_approval.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('Musrenbang.walikota_approval.show', compact('data', 'status'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $input['status_usulan'] = 4; //approved walikota
        ...
        try {
            ...
            return redirect()->route('Musrenbang.Approval-Walikota.index')->with('success', 'Approved Walikota!');
        } catch (\Exception $e) {
            \DB::rollback();
    ...
    {
        return $this->usulanUrusanRepo->walikotaDataTables();
    }
}
