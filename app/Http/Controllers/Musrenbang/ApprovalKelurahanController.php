...
class ApprovalKelurahanController extends Controller
{
    ...
    {
        return view('Musrenbang.kelurahan_approval.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('Musrenbang.kelurahan_approval.show', compact('data', 'status'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $input['status_usulan'] = 2;//approved kelurahan
        ...
        try {
            ...
            return redirect()->route('Musrenbang.Approval-Kelurahan.index')->with('success', 'Approved Kelurahan!');
        } catch (\Exception $e) {
            \DB::rollback();
    ...
    {
        return $this->usulanUrusanRepo->kelurahanDataTables();
    }
}
