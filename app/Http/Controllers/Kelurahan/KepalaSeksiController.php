...
class KepalaSeksiController extends Controller
{
    ...
    public function update(Request $request, $id) {
        return $this->surat->updateHeadOfSection($request, \Crypt::decryptString($id));
    }

    public function destroy($id) {}

    public function dataTablesKepalaSeksiNoSearch() {
        return $this->surat->dataTablesKepalaSeksiNoSearch();
    }

    public function dataTables(Request $request) {
        return $this->surat->dataTablesKepalaSeksi($request);
    }
}
