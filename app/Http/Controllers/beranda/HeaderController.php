...
{   
    public function __construct(HeaderRepository $_HeaderRepository, RajaOngkirRepository $rajaOngkir, UserRepository $_user)
    {
    ...
    {   
        return $this->header->store($request);
    ...
    {   
        ...
        $data = $this->header->show($id);
        $headerGetAlamat = $this->header->getAlamat($id);

        return view($this->route1.'.'.$this->route2.'.'.$this->route3,compact('data', 'headerGetAlamat'));
    }
    ...
    {   
        ...
        return $this->header->update($request,$id);
    }

    public function destroy($id)
    {
        return $this->header->delete($id);
    }

    public function dataTables(Request $request)
    {
        return $this->header->dataTables($request);
    }
}
