...
{   
    public function __construct(KontakRepository $_KontakRepository, RajaOngkirRepository $rajaOngkir, UserRepository $_user)
    {
    ...
    {   
        return $this->kontak->store($request);
    }
    ...
    {   
        ...
        $data = $this->kontak->show($id);
        $kontakGetAlamat = $this->kontak->getAlamat($id);

        return view($this->route1.'.'.$this->route2.'.'.$this->route3,compact('data', 'kontakGetAlamat'));
    }
    ...
    {   
        ...
        return $this->kontak->update($request,$id);
    }

    public function destroy($id)
    {
        return $this->kontak->delete($id);
    }

    public function dataTables(Request $request)
    {
        return $this->kontak->dataTables($request);
    }
}
